                    ...
                    <div className='image'>
                        ...
                        <div className='overlay'>
                            <div className='socials'>
                                <ul>
                                    <li><a href={team.faceLink}><i className='fab fa-facebook-f'></i></a></li>
                                    <li><a href={team.twitLink}><i className='fab fa-twitter'></i></a></li>
